...
public class ChessMatch {
	...
	private void InitialSetup() {
        ...
        placeNewPiece('c', 7, new Rook(board, Color.BACK));
        placeNewPiece('c', 8, new Rook(board, Color.BACK));
        placeNewPiece('d', 7, new Rook(board, Color.BACK));
        placeNewPiece('e', 7, new Rook(board, Color.BACK));
        placeNewPiece('e', 8, new Rook(board, Color.BACK));
        placeNewPiece('d', 8, new King(board, Color.BACK));
	}
}
